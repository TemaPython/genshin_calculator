...
perc_dict = {'Альбедо':Albedo(), 'Аратаки Итто':AratakiItto(),'Горо':Gorou(),'Путешественник (Гео)':TravelerGeo(),
             'Нин Гуан':Ningguang(), 'Ноэлль':Noelle(),'Юнь Цзинь':YunJin(),'Чжун Ли':Zhongli(),'Ху Тао':HuTao()}
...
perc = ['Не выбрано','Альбедо', 'Аратаки Итто','Горо','Путешественник (Гео)',
             'Нин Гуан', 'Ноэлль','Юнь Цзинь','Чжун Ли','Ху Тао']
